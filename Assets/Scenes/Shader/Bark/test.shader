    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct SurfaceInput
            {
                ...
                // .w = fogCoord (standard)
                float4 viewDirectionWS : TEXCOORD6;
        ...
        Pass
        {
            ...
            struct SurfaceInput
            {
                ...
                float noise : TEXCOORD11; // TODO: pack noise into positionWS.w or normalWS.w
                float debug : TEXCOORD12; // TODO: pack noise into positionWS.w or normalWS.w
